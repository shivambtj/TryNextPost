      ...
      <div className="max-w-7xl mx-auto px-8 py-20 w-full">
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div>
            ...
            <p className="mt-8 text-xl text-[#00247D] max-w-xl leading-relaxed">
            ...
            <div className="mt-10 inline-block bg-white rounded-2xl px-4 py-2 shadow-lg">
              <span className="text-2xl font-bold text-[#D9044F]">
                Starts at just ₹19/500g*
              </span>
            </div>

            <div>
              <button className="mt-8 bg-[#D9044F] hover:bg-pink-700 text-white px-4 py-2 rounded-full text-xl font-semibold transition">
                Try for FREE
              </button>
            </div>
